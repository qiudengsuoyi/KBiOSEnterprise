...
- (void)viewDidLoad {
    ...
    [self.tbList registerNib:[UINib nibWithNibName:NSStringFromClass([ItemSelectTableViewCell class]) bundle:nil] forCellReuseIdentifier:NSStringFromClass([ItemSelectTableViewCell class])];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ItemSelectTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([ItemSelectTableViewCell class])];
    if (cell == nil) {
        cell = [[ItemSelectTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:NSStringFromClass([UITableViewCell class])] ;
    }
