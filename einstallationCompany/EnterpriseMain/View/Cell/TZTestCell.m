...
- (void)layoutSubviews {
    ...
    _imageView.frame = CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height-4);
    ...
    _videoImageView.frame = CGRectMake(width, width, width-10, width);
    _progressView.frame = CGRectMake(0, self.self.bounds.size.height-4, self.bounds.size.width, 10);
}
