...
@interface GrabFailViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate, UITextViewDelegate>
...
@implementation GrabFailViewController
