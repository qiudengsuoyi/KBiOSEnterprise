...
@interface GrabAuditTabViewController ()<SGPageContentScrollViewDelegate>
...
@implementation GrabAuditTabViewController
...
- (void)viewDidLoad {
    ...
    GrabAuditViewController *vc = [[GrabAuditViewController alloc]init];
    vc.pageType = @"3";
    GrabAuditViewController *vc1 = [[GrabAuditViewController alloc]init];
    vc1.pageType = @"4";
